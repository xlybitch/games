...
function init() {
	...
	var btn = document.getElementById('normalmodeready-btn');
	...
	var btn = document.getElementById('plusmodeready-btn');
    btn.className = 'btn btn-primary btn-lg';
    btn.onclick = function () {
		_gameTimeNum=86400;
		GameTimeLayer.innerHTML = ('∞');
		GameTimeLayer='∞';
        closeWelcomeLayer();
    }
}
...
function shareText(score) {
    ...
    if (score === 100) return '哼哼哼啊啊啊啊啊啊啊啊';

    if (score <= 49) return '小薛生...';
    if (score <= 99) return '小有薛就...';
    if (score <= 149) return '进击的薛eee';
    return 'Xue Pro!!!';
}
...
console.log("不修改，好嘛？起飞了又有什么用呢？(ˉ▽ˉ；)...")
